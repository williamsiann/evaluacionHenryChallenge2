...
function cuantosOnline(usuarios) {
  ...
  // Tu código aca:
  let contador = 0; // creamos una variable para contar el número de usuarios en línea

  for (let usuario in usuarios) { // recorremos el objeto usuarios con un ciclo for-in
    if (usuarios[usuario].online) { // si la propiedad online del usuario es verdadera
